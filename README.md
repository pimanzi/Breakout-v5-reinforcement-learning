...
| **Exp 2**  | CNN            | **0.0005**    | 0.99      | 16         | 1.0           | 0.01        | 100,000     | **13.0** ⭐ |
| **Exp 3**  | CNN            | **0.00005**   | 0.99      | 32         | 1.0           | 0.2        | 100,000     | **6.0**     |
...
| **Exp 7**  | CNN            | 0.0001        | 0.99      | 16        | 1.0           | **0.05**    | 100,000     | **12.0** 🥈 |
| **Exp 8**  | CNN            | 0.0001        | 0.99      | 32         | 1.0           | 0.01        | 100,000     | **6.0**     |
| **Exp 9**  | CNN            | 0.0002       | 0.99      | 32         | 1.0           | 0.03        | 100,000     | **5.0**     |
...
| **Exp 4**  | 0.0001        | 0.99  | 32         | 80000        | 0.2                   | 0.05                  | **8.0**     |
| **Exp 5**  | 0.0001        | 0.99  | 64         | 95000        | 0.1                   | 0.01                  | **5.0**     |
| **Exp 6**  | 0.00005       | 0.99  | 32         | 90000        | 0.1                   | 0.01                  | **5.0**     |
| **Exp 7**  | 0.0001        | 0.98  | 32         | 100000       | 0.15                  | 0.02                  | **7.0**     |
...
Across the 10 experiments, mean rewards were generally low, ranging from 5.0 to 8.0. The best-performing experiments were **Exp 3**, **Exp 4**, and **Exp 7**. Exp 3 had a slightly higher learning rate, Exp 4 had more exploration, and Exp 7 combined moderate exploration with a lower gamma, helping the agents discover slightly better strategies.

The other experiments all averaged around 5.0, showing that small adjustments in batch size, gamma, or buffer size had limited impact. Exp 10, using an MLP instead of CNN, performed worst, highlighting that CNNs are better suited for visual tasks like Breakout. Overall, the results suggest that longer training or more aggressive exploration would be needed for meaningful performance improvements.
...
| **4**      | CNN            | 0.0001        | 0.99      | 32         | 1.0           | 0.01        | **500,000** | **9.0**     |
...
| **9**      | CNN            | 0.0002        | 0.99      | 32         | 1.0           | 0.03        | 100,000     | **7.0**     |
| **10**     | **MLP**        | 0.0001        | 0.99      | 32         | 1.0           | 0.01        | 100,000     | **3.0**     |
